  ...
  return (
    ...
    >
      <Page size="LETTER" style={styles.page}>
        ...
        {/* Page 2 — forced break + paddingTop so the Negotiation Script
            section always opens a fresh page with ~1 inch of blank space
            above it. Page 1 layout is untouched. */}
