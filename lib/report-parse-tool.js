  ...
  input_schema: {
    ...
    properties: {
      ...
      neighborhood: {
        type: "string",
        description:
          "Submarket / sub-neighborhood name when recognizable (e.g. 'Old Northwood', 'El Cid', 'SoSo', 'Flamingo Park'). Only fall back to the city name when no distinct submarket exists. Do NOT prefix with the city.",
      },
      ...
      land_arbitrage_notes: {
        type: "string",
        description: "One-sentence plain-English explanation of the land_arbitrage_score.",
      },
      score_breakdown: {
        type: "object",
        description: "Transparent breakdown of the negotiability_score components, each 0-10.",
        properties: {
          dom_score: { type: "number" },
          price_cut_score: { type: "number" },
          zestimate_gap_score: { type: "number" },
          price_per_sqft_score: { type: "number" },
        },
      },
