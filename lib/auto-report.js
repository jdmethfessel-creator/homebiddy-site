...
- neighborhood: the submarket / sub-neighborhood name when recognizable (e.g. "Old Northwood", "El Cid", "SoSo", "Flamingo Park"). Only fall back to the city name when no distinct submarket exists. Do NOT prefix with the city.
