...
export async function analyzeWithClaude(listing_url, { model } = {}) {
    ...
    tools: [
      {
        ...
        name: "web_search",
        // Phase 1 is the core report extraction — listing data, comps,
        // scores. Capped at 4 searches so the function reliably finishes
        // under maxDuration. Lifestyle / schools / taxes are pulled by
        // analyzeEnrichment() in Phase 2 after Phase 1 has already
