...
LISTING PRICE
- listing price and price history: read the full Price History table on the listing page. The CURRENT asking price is the most recent 'Price change' or active listing price at the top of the table -- never the original 'Listed for sale' price. Zillow shows a 'Price cut: $X (date)' badge directly above the current price in large text. The number displayed below that badge is the current asking price -- use it. It is more reliable than the price history table. Count only 'Price change' events as price_cuts. Build cut_history as an array of strings from those rows, most recent first, format: '$2,595,000 → $2,395,000 (Feb 2024)'. Also note the most recent 'Sold' row for last_sold_price and last_sold_year.
...
LISTING PRICE
- listing price and price history: read the full Price History table on the listing page. The CURRENT asking price is the most recent 'Price change' or active listing price at the top of the table -- never the original 'Listed for sale' price. Zillow shows a 'Price cut: $X (date)' badge directly above the current price in large text. The number displayed below that badge is the current asking price -- use it. It is more reliable than the price history table. Count only 'Price change' events as price_cuts. Build cut_history as an array of strings from those rows, most recent first, format: '$2,595,000 → $2,395,000 (Feb 2024)'.
