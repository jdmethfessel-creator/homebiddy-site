...
LIFESTYLE + SCHOOLS (search the web for these)
- walk_score (0-100), transit_score (0-100), bike_score (0-100): query
  "[address] walk score" — these come from walkscore.com. Omit any score
  that isn't available.
- elementary_school, middle_school, high_school: nearest assigned school
  by name. elementary_rating, middle_rating, high_rating: rating out of
  10 from greatschools.org (or niche.com when GreatSchools is missing).
- school_rating_avg: mean of the three school ratings, one decimal.
- commute_to_downtown_min: estimated peak-time drive in minutes to the
  city's main downtown / CBD.
- nearest_grocery_min: estimated drive time in minutes to the nearest
    ...
    tools: [
      {
        ...
        name: "web_search",
        // Dropped from 8 → 6 so a slow listing can't exhaust the function
        // budget on a single attempt; analysis routinely came in under 6
        // searches anyway.
        max_uses: 6,
      },
    ],
